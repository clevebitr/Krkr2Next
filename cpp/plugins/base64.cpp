//---------------------------------------------------------------------------
// base64.dll —— Base64 编解码
//---------------------------------------------------------------------------
// 移植自 AetherKiri cpp/plugins/base64.cpp（同源实现，逐行对照）。
// 老 KiriKiri2 / KAG 时代游戏常用它做存档与文本编码；本引擎此前没有注册这个
// 名字，脚本 Plugins.link("base64.dll") 会直接失败。
// 纯算法实现，不依赖平台，Android 上完全可用。
//---------------------------------------------------------------------------
#include "ncbind.hpp"
#include "tp_stub.h"
