...
static void PVRDecompress(AMTC_BLOCK_STRUCT *pCompressedData,
                          const bool Do2bitMode, const int XDim, const int YDim,
 ...
 *************************************************************************/
int PVRTDecompressPVRTC(const void *const pCompressedData, const int XDim,
                        const int YDim, void *pDestData,
                        const bool Do2bitMode) {
    PVRDecompress((AMTC_BLOCK_STRUCT *)pCompressedData, Do2bitMode, XDim, YDim,
                  1, (unsigned char *)pDestData);
...
static void Unpack5554Colour(const AMTC_BLOCK_STRUCT *pBlock,
    ...
    for(i = 0; i < 2; i++) {
        ...
        } else // Else if colour has variable translucency
        {
            ...
            /*
             expand from 3 to 5 bits if this is from colour A, or 4 to 5 bits if
             from colour B
             */
            if(i == 0) {
