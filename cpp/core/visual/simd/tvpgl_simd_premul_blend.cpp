...
namespace krkr2 {
    namespace HWY_NAMESPACE {
        ...
        void AdditiveAlphaBlend_HWY(tjs_uint32 *dest, const tjs_uint32 *src,
                                    tjs_int len) {
            ...
            // Scalar reference does NOT scale the dest alpha byte; result alpha
            // = src_a
            ...
            for(; i + static_cast<tjs_int>(N_PIXELS) <= len; i += N_PIXELS) {
                ...
                // Scale dest by inverse alpha: d_scaled = (dest * inv_alpha) >>
                // 8
                ...
                // Zero the alpha byte of d_scaled to match scalar (result alpha
                // = src_a)
        ...
        void AdditiveAlphaBlend_HDA_HWY(tjs_uint32 *dest, const tjs_uint32 *src,
                                        tjs_int len) {
            const hn::ScalableTag<uint8_t> d8;
            const hn::Repartition<uint16_t, decltype(d8)> d16;
            const size_t N8 = hn::Lanes(d8);
        ...
        void AdditiveAlphaBlend_HDA_o_HWY(tjs_uint32 *dest,
         ...
         */
        void AdditiveAlphaBlend_a_HWY(tjs_uint32 *dest, const tjs_uint32 *src,
                                      tjs_int len) {
        ...
        /*
         * AdditiveAlphaBlend_ao: Both src and dest pre-multiplied alpha, with
         * opacity. First scale src by opacity, then do additive alpha blend.
         */
...
void TVPAdditiveAlphaBlend_HDA_o_hwy(tjs_uint32 *dest, const tjs_uint32 *src,
                                     tjs_int len, tjs_int opa) {
    krkr2::HWY_DYNAMIC_DISPATCH(AdditiveAlphaBlend_HDA_o_HWY)(dest, src, len,
                                                              opa);
}
