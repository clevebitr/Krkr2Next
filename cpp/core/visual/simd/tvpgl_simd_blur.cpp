...
namespace krkr2 {
    namespace HWY_NAMESPACE {
        ...
        // =========================================================================
        // TVPAddSubVertSum16: dest[ch] += addline_ch - subline_ch for all
        // channels
        // =========================================================================
        void AddSubVertSum16_HWY(tjs_uint16 *dest, const tjs_uint32 *addline,
            ...
            for(; i + static_cast<tjs_int>(N16) <= ch_count; i += N16) {
                ...
                auto va8 = hn::LoadU(
                    d8, reinterpret_cast<const uint8_t *>(addline) + i);
                auto vs8 = hn::LoadU(
                    d8, reinterpret_cast<const uint8_t *>(subline) + i);
                auto va = hn::PromoteTo(
                    d16, hn::LowerHalf(hn::Half<decltype(d8)>(), va8));
                auto vs = hn::PromoteTo(
                    d16, hn::LowerHalf(hn::Half<decltype(d8)>(), vs8));
        ...
        void AddSubVertSum32_HWY(tjs_uint32 *dest, const tjs_uint32 *addline,
            ...
            for(; i + static_cast<tjs_int>(N32) <= ch_count; i += N32) {
                ...
                auto va_lo16 = hn::PromoteTo(
                    d16, hn::LowerHalf(hn::Half<decltype(d8)>(), va_u8));
                auto vs_lo16 = hn::PromoteTo(
                    d16, hn::LowerHalf(hn::Half<decltype(d8)>(), vs_u8));

                auto va32 = hn::PromoteTo(
                    d32, hn::LowerHalf(hn::Half<decltype(d16)>(), va_lo16));
                auto vs32 = hn::PromoteTo(
                    d32, hn::LowerHalf(hn::Half<decltype(d16)>(), vs_lo16));
        ...
        void DoBoxBlurAvg32_HWY(tjs_uint32 *dest, tjs_uint32 *sum,
            ...
            for(tjs_int i = 0; i < len; i++) {
                tjs_uint32 b = static_cast<tjs_uint32>(
                    ((tjs_uint64)(sum[0] + half_n) * rcp) >> 32);
                tjs_uint32 g = static_cast<tjs_uint32>(
                    ((tjs_uint64)(sum[1] + half_n) * rcp) >> 32);
                tjs_uint32 r = static_cast<tjs_uint32>(
                    ((tjs_uint64)(sum[2] + half_n) * rcp) >> 32);
                tjs_uint32 a = static_cast<tjs_uint32>(
                    ((tjs_uint64)(sum[3] + half_n) * rcp) >> 32);
        ...
        void DoBoxBlurAvg32_d_HWY(tjs_uint32 *dest, tjs_uint32 *sum,
            ...
            for(tjs_int i = 0; i < len; i++) {
                tjs_int a = static_cast<tjs_int>(
                    ((tjs_uint64)(sum[3] + half_n) * rcp) >> 32);
                tjs_uint8 *t = ::TVPDivTable + (a << 8);

                tjs_uint32 b_avg = static_cast<tjs_uint32>(
                    ((tjs_uint64)(sum[0] + half_n) * rcp) >> 32);
                tjs_uint32 g_avg = static_cast<tjs_uint32>(
                    ((tjs_uint64)(sum[1] + half_n) * rcp) >> 32);
                tjs_uint32 r_avg = static_cast<tjs_uint32>(
                    ((tjs_uint64)(sum[2] + half_n) * rcp) >> 32);

                dest[i] =
                    t[b_avg] + (t[g_avg] << 8) + (t[r_avg] << 16) + (a << 24);
        ...
        // TVPChBlurAddMulCopy65: dest = min(dest + src * level >> 18, 255)
        // (accumulate + saturate)
        ...
        // TVPChBlurMulCopy: 256-level version, dest = min(src * level >> 8,
        // 255) (overwrite)
        ...
        // TVPChBlurAddMulCopy: 256-level version, dest = min(dest + src * level
        // >> 8, 255)
...
void TVPAddSubVertSum16_hwy(tjs_uint16 *dest, const tjs_uint32 *addline,
                            const tjs_uint32 *subline, tjs_int len) {
    krkr2::HWY_DYNAMIC_DISPATCH(AddSubVertSum16_HWY)(dest, addline, subline,
                                                     len);
}
void TVPAddSubVertSum16_d_hwy(tjs_uint16 *dest, const tjs_uint32 *addline,
                              const tjs_uint32 *subline, tjs_int len) {
    krkr2::HWY_DYNAMIC_DISPATCH(AddSubVertSum16_d_HWY)(dest, addline, subline,
                                                       len);
}
void TVPAddSubVertSum32_hwy(tjs_uint32 *dest, const tjs_uint32 *addline,
                            const tjs_uint32 *subline, tjs_int len) {
    krkr2::HWY_DYNAMIC_DISPATCH(AddSubVertSum32_HWY)(dest, addline, subline,
                                                     len);
}
void TVPAddSubVertSum32_d_hwy(tjs_uint32 *dest, const tjs_uint32 *addline,
                              const tjs_uint32 *subline, tjs_int len) {
    krkr2::HWY_DYNAMIC_DISPATCH(AddSubVertSum32_d_HWY)(dest, addline, subline,
                                                       len);
}
void TVPDoBoxBlurAvg16_hwy(tjs_uint32 *dest, tjs_uint16 *sum,
                           const tjs_uint16 *add, const tjs_uint16 *sub,
                           tjs_int n, tjs_int len) {
    krkr2::HWY_DYNAMIC_DISPATCH(DoBoxBlurAvg16_HWY)(dest, sum, add, sub, n,
                                                    len);
}
void TVPDoBoxBlurAvg16_d_hwy(tjs_uint32 *dest, tjs_uint16 *sum,
                             const tjs_uint16 *add, const tjs_uint16 *sub,
                             tjs_int n, tjs_int len) {
    krkr2::HWY_DYNAMIC_DISPATCH(DoBoxBlurAvg16_d_HWY)(dest, sum, add, sub, n,
                                                      len);
}
void TVPDoBoxBlurAvg32_hwy(tjs_uint32 *dest, tjs_uint32 *sum,
                           const tjs_uint32 *add, const tjs_uint32 *sub,
                           tjs_int n, tjs_int len) {
    krkr2::HWY_DYNAMIC_DISPATCH(DoBoxBlurAvg32_HWY)(dest, sum, add, sub, n,
                                                    len);
}
void TVPDoBoxBlurAvg32_d_hwy(tjs_uint32 *dest, tjs_uint32 *sum,
                             const tjs_uint32 *add, const tjs_uint32 *sub,
                             tjs_int n, tjs_int len) {
    krkr2::HWY_DYNAMIC_DISPATCH(DoBoxBlurAvg32_d_HWY)(dest, sum, add, sub, n,
                                                      len);
}
